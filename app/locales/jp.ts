...
const jp: PartialLocaleType = {
 ...
 `,
  ...
  Auth: {
    ...
    TopTips:
      "🥳 大模型聚合系统 AIの発売特典で、OpenAI o1、GPT-4o、Claude-3.5などの最新の大規模モデルを今すぐアンロック",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "大模型聚合系统 AIを使用する",
        Label: "(コストパフォーマンスの最も高いソリューション)",
        SubTitle:
          "大模型聚合系统によって公式に管理されており、設定なしですぐに使用でき、OpenAI o1、GPT-4o、Claude-3.5などの最新の大規模モデルをサポートしています",
        ChatNow: "今すぐチャット",
      },
