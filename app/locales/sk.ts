...
const sk: PartialLocaleType = {
 ...
 `,
  ...
  Auth: {
    ...
    TopTips:
      "🥳 Uvítacia ponuka 大模型聚合系统 AI, okamžite odomknite OpenAI o1, GPT-4o, Claude-3.5 a najnovšie veľké modely",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Použite 大模型聚合系统 AI",
        Label: "(Najvýhodnejšie riešenie)",
        SubTitle:
          "Oficiálne udržiavané 大模型聚合系统, pripravené na použitie bez konfigurácie, podporuje najnovšie veľké modely ako OpenAI o1, GPT-4o a Claude-3.5",
