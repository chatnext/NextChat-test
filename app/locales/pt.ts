...
`,
  ...
  Auth: {
    ...
    TopTips:
      "🥳 Oferta de Lançamento do 大模型聚合系统 AI, desbloqueie o OpenAI o1, GPT-4o, Claude-3.5 e os mais recentes grandes modelos agora",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Usar 大模型聚合系统 AI",
        Label: "(A solução mais econômica)",
        SubTitle:
          "Mantido oficialmente pelo 大模型聚合系统, pronto para uso sem configuração, suporta os mais recentes grandes modelos como OpenAI o1, GPT-4o e Claude-3.5",
